...
class SettingsController extends Controller
{
    ...
    public function updateHomePage(Request $request, $id)
    {
        ...
        if ($request->hasFile('banner_photo')) {
            ...
            $banner_photo_path = 'uploads/banner/' . $name;
        ...
        if ($request->hasFile('what_photo')) {
            ...
            Image::make($what_photo)->save('uploads/banner/' . $name);

            $what_photo_path = 'uploads/banner/' . $name;
        ...
        if ($request->hasFile('feature_card_icon_1')) {
            ...
            Image::make($feature_card_icon_1)->save('uploads/banner/' . $name);

            $feature_card_icon_1_path = 'uploads/banner/' . $name;
        ...
        if ($request->hasFile('feature_card_icon_2')) {
            ...
            Image::make($feature_card_icon_2)->save('uploads/banner/' . $name);

            $feature_card_icon_2_path = 'uploads/banner/' . $name;
        ...
        if ($request->hasFile('feature_card_icon_3')) {
            ...
            Image::make($feature_card_icon_3)->save('uploads/banner/' . $name);

            $feature_card_icon_3_path = 'uploads/banner/' . $name;
        ...
        if ($request->hasFile('feature_card_icon_4')) {
            ...
            Image::make($feature_card_icon_4)->save('uploads/banner/' . $name);

            $feature_card_icon_4_path = 'uploads/banner/' . $name;
        ...
        if ($request->hasFile('feature_card_icon_5')) {
            ...
            Image::make($feature_card_icon_5)->save('uploads/banner/' . $name);

            $feature_card_icon_5_path = 'uploads/banner/' . $name;
        ...
        if ($request->hasFile('feature_card_icon_6')) {
            ...
            Image::make($feature_card_icon_6)->save('uploads/banner/' . $name);

            $feature_card_icon_6_path = 'uploads/banner/' . $name;
        ...
        if ($request->hasFile('feature_card_icon_7')) {
            ...
            Image::make($feature_card_icon_7)->save('uploads/banner/' . $name);

            $feature_card_icon_7_path = 'uploads/banner/' . $name;
        ...
        if ($request->hasFile('feature_card_icon_8')) {
            ...
            Image::make($feature_card_icon_8)->save('uploads/banner/' . $name);

            $feature_card_icon_8_path = 'uploads/banner/' . $name;
        ...
        if ($request->hasFile('feature_card9_photo')) {
            ...
            Image::make($feature_card9_photo)->save('uploads/banner/' . $name);

            $feature_card9_photo_path = 'uploads/banner/' . $name;
        ...
        if ($request->hasFile('feature_card10_photo')) {
            ...
            Image::make($feature_card10_photo)->save('uploads/banner/' . $name);

            $feature_card10_photo_path = 'uploads/img/' . $name;
        ...
        if ($request->hasFile('feature_card11_photo')) {
            ...
            Image::make($feature_card11_photo)->save('uploads/banner/' . $name);

            $feature_card11_photo_path = 'uploads/banner/' . $name;
        ...
        if ($request->hasFile('feature_card12_photo')) {
            ...
            Image::make($feature_card12_photo)->save('uploads/banner/' . $name);

            $feature_card12_photo_path = 'uploads/banner/' . $name;
        ...
        if ($request->hasFile('feature_card13_photo')) {
            ...
            Image::make($feature_card13_photo)->save('uploads/banner/' . $name);

            $feature_card13_photo_path = 'uploads/banner/' . $name;
    ...
    public function backupDelete($id)
    {
        DB::beginTransaction();
        try {
            $data = Backup::findOrFail($id);
            $data->delete();
        } catch (\Exception $e) {
            DB::rollback();
            Toastr::error(trans('Unable to delete your backup schedule !'), 'Error', ["positionClass" => "toast-top-right"]);
            return redirect()->back();
        }
        DB::commit();
        Toastr::success(trans('Backup schedule deleted successfully !'), 'Success', ["positionClass" => "toast-top-right"]);
        return redirect()->back();
    }
    ...
    public function scheduleBackupDB()
    {
        ...
        return $filename = 'uploads/backup/' . $filename;
    }
    ...
    public function scheduleBackupStore(Request $request) 
    {
        $request->validate([
            ...
            'backup_item' => 'required',
            'backup_datetime' => $request->backup_type === 'non-reoccurrence' ? 'required|date' : 'nullable',
            'reoccurrence_type' => $request->backup_type === 'reoccurrence' ? 'required' : 'nullable',
        ]);
        ...
        try {
            ...
            if ($request->backup_type === 'non-reoccurrence') {
                $backup->date = $request->backup_datetime;
                $backup->recurrence = 0;

            } else if ($request->backup_type === 'reoccurrence') {
                $now = Carbon::now();
                switch ($request->reoccurrence_type) {
                    case 'weekly':
                        $backup->date = $now->addWeek();
                        $backup->recurrence_type = 'weekly';
                        break;
                    case 'monthly':
                        $backup->date = $now->addMonth();
                        $backup->recurrence_type = 'monthly';
                        break;
                    case 'quarterly':
                        $backup->date = $now->addMonths(3);
                        $backup->recurrence_type = 'quarterly';
                        break;
                    case 'yearly':
                        $backup->date = $now->addYear();
                        $backup->recurrence_type = 'yearly';
                        break;
                }
                $backup->recurrence = 1;
            }
