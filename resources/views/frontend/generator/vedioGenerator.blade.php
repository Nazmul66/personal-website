        ...
        <div class="rbt-daynamic-page-content">
            ...
            <div class="rbt-dashboard-content">
                        ...
                        <div class="chat-box author-speech bg-flashlight">
                            <div class="inner">
                                <div class="chat-section">
                                    <div class="author">
                                        <img class="w-100" src="{{ asset('assets/images/team/team-01.png') }}"
                                            alt="Author">
                                    </div>
                                    <div class="chat-content">
                                        <h6 class="title">You</h6>
                                        <p class="mb--10"> Generate a conversational avatar for the provided script.</p>
                                        <p class="mb--20">Create an engaging video now using our cutting-edge Talking Avatar
                                            Video Creator! This powerful tool lets you effortlessly craft captivating
                                            videos, featuring a virtual spokesperson delivering your personalized message
                                            with a natural touch. Whether you're marketing a product, sharing business
                                            updates, or conducting training sessions, our innovative AI technology
                                            simplifies the process, ensuring polished videos that captivate audiences and
                                            drive impactful results. Take command, try it out today, and witness the
                                            transformative difference firsthand.</p>
                                        <div class="img-box">
                        ...
                        <div class="chat-box ai-speech bg-flashlight">
                            <div class="inner top-flashlight leftside light-xl">
                                ...
                                <div class="chat-section generate-details-section">
                                    ...
                                    <div class="chat-content">
                                        <h6 class="title mb--20">In alignment with the gender identified in the uploaded
                                            image, the video has been automatically generated with a male voice.
                                            Nevertheless, you retain the flexibility to tailor your video by choosing from
                                            the provided customization options below:</h6>

                                        <div class="image-caption mb--20">
                                            <h5 class="caption-title theme-gradient">Unleash the Power of Persuasion! 3:1
                                                --q 4 --s 580</h5>
                                        </div>
                                        <div
                                            class="video-popup icon-center frame-image gradient-secondary frame-image-author mb--20">
                                            <img class="radius-small"
                                                src="{{ asset('assets/images/generator-img/video-photo-1.png') }}"
                                                alt="Banner Images">
                                            ...
                                            <div class="btn-grp">
                                                <div class="left-side-btn dropup">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        ...
                                                        <li><a class="dropdown-item" href="#"><i
                                                                    class="feather-file-text"></i> Rename</a></li>
                                                        <li><a class="dropdown-item delete-item" href="#"><i
                                                                    class="feather-trash-2"></i> Delete Chat</a></li>
                                                    </ul>
                                                </div>
                            ...
                            <div class="inner">
                                <div class="chat-section">
                                    ...
                                    <div class="chat-content">
                                        ...
                                        <p class="mb--20">Create a Stunning Video Featuring Our Elegant Female Character.
                                            Here is the character's photo</p>
                                        <div class="img-box">
                                            <img class="w-50 radius"
                                                src="{{ asset('assets/images/generator-img/photo-14.png') }}"
                                                alt="Image Generation">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="chat-section generate-details-section">
                                    ...
                                    <div class="chat-content">
                                        ...
                                        <div
                                            class="video-popup icon-center frame-image gradient-secondary frame-image-author mb--20">
                                            <img class="radius-small"
                                                src="{{ asset('assets/images/generator-img/video-photo-2.png') }}"
                                                alt="Banner Images">
                                            <div class="video-icon">
                                                <a class="btn-default rounded-player popup-video border bg-white-dropshadow"
                ...
                <div class="rbt-static-bar">
                    ...
                    <p class="b3 small-text">CraftedFate can make mistakes. Consider checking important information.</p>
                </div>
            </div>
                        ...
                        <ul class="chat-history-list">
                            <li class="history-box active">
                                ...
                                <div class="dropdown history-box-dropdown">
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" href="#"><i class="feather-refresh-cw"></i>
                                                Regenerate</a></li>
                                        <li><a class="dropdown-item" href="#"><i class="feather-tag"></i> Pin
                                                Chat</a></li>
                                        <li><a class="dropdown-item" href="#"><i class="feather-file-text"></i>
                                                Rename</a></li>
                                        <li><a class="dropdown-item" href="#"><i class="feather-share-2"></i>
                                                Share</a></li>
                                        <li><a class="dropdown-item delete-item" href="#"><i
                                                    class="feather-trash-2"></i> Delete Chat</a></li>
                                    </ul>
