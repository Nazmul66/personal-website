                        ...
                        <div class="chat-box ai-speech bg-flashlight">
                            <div class="inner top-flashlight leftside light-xl">
                                ...
                                <div class="chat-section">
                                    ...
                                    <div class="chat-content">
                                        <h6 class="title">CraftedFate <span class="rainbow-badge-card">Bot</span></h6>
                                        <p class="mb--20">A chat AI, or chatAi, is a type of artificial intelligence
                                            designed to simulate conversation with human users, especially through natural
                                            language processing. These systems are often used in various applications,
                                            including customer service, virtual assistants, and online interactions.</p>
                        ...
                        <div class="chat-box ai-speech bg-flashlight">
                            <div class="inner top-flashlight leftside light-xl">
                                ...
                                <div class="chat-section">
                                    ...
                                    <div class="chat-content">
                                        <h6 class="title">CraftedFate <span class="rainbow-badge-card">Bot</span></h6>
                                        <p class="mb--20">ChatAi boost operational efficiency and bring cost savings to
                                            businesses while offering convenience and added services to internal employees
                                            and external customers. They allow companies to easily resolve many types of
                                            customer queries and issues while reducing the need for human interaction.</p>
                                        <div class="reaction-section">
                                            <div class="btn-grp">
                                                <div class="left-side-btn dropup">
                                                    <button data-bs-toggle="modal" data-bs-target="#likeModal"
                        ...
                        <div class="chat-box ai-speech bg-flashlight">
                            <div class="inner top-flashlight leftside light-xl">
                                ...
                                <div class="chat-section">
                                    ...
                                    <div class="chat-content">
                                        <h6 class="title">CraftedFate <span class="rainbow-badge-card">Bot</span></h6>
                                        <p>You're already talking to a chat AI right now! You can ask me anything or discuss
                                            various topics. Just type your questions or statements, and I'll do my best to
                                            provide helpful and informative responses.</p>
                                        <p class="mb--20">If you have a specific topic in mind or if there's something
                                            you'd like to know or discuss, feel free to let me know!</p>
                                        <div class="reaction-section">
                                            <div class="btn-grp">
                                                <div class="left-side-btn dropup">
                                                    <button data-bs-toggle="modal" data-bs-target="#likeModal"
                        ...
                        <div class="chat-box ai-speech bg-flashlight">
                            <div class="inner top-flashlight leftside light-xl">
                                ...
                                <div class="chat-section">
                                    ...
                                    <div class="chat-content">
                                        <h6 class="title">CraftedFate <span class="rainbow-badge-card">Bot</span></h6>
                                        <p class="mb--20">While CraftedFate is a powerful language model that has been
                                            trained on a diverse range of internet text, it doesn't know everything. It has
                                            limitations</p>
                                        <div class="reaction-section">
                                            <div class="btn-grp">
                                                <div class="left-side-btn dropup">
