    ...
    <div class="container position-relative">
        <div class="row align-items-center row--0">
            <div class="col-lg-3 col-md-6 col-6">
                <div class="logo">
                    <a href="{{ url('/') }}">
                        <img class="logo-light" src="{{ asset(getSetting()->site_logo) }}" alt="{{ getSetting()->site_name }}"
                            style="max-height: 72px !important;">
                        <img class="logo-dark" src="{{ asset(getSetting()->site_logo) }}"
                            alt="{{ getSetting()->site_name }}" style="max-height: 72px !important;">
                    </a>
                </div>
            </div>
