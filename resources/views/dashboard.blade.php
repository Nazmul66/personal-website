    ...
    <div class="rbt-main-content mr--0">
        <div class="rbt-daynamic-page-content">
            ...
            <div class="rbt-dashboard-content">
                ...
                <div class="content-page" style="margin-top: 12rem;">
                    <div class="chat-box-list">
                        ...
                        <div class="welcome-wrapper">
                            ...
                            <div class="btn-section">
                                <a class="btn-default bg-solid-primary" data-bs-toggle="modal"
                        ...
                        <div class="rainbow-generartor-section rainbow-section-gap">
                            ...
                            <div class="genarator-section">
                                <ul class="genarator-card-group">
                                    <li>
                                        <a href="{{ route('user.dashboard.textGenerator') }}" class="genarator-card">
                                            <div class="inner">
                                    ...
                                    <li>
                                        <a href="image-editor" class="genarator-card">
                                            <div class="inner">
                                                <div class="left-align">
                                                    <div class="img-bar">
                                                        <img src="{{ asset('') }}assets/images/generator-icon/photo-editor.png"
                                                            alt="AI Generator">
                                                    </div>
                                    ...
                                    <li>
                                        <a href="{{ route('user.dashboard.codeGenerator') }}" class="genarator-card">
                                            <div class="inner">
                                                <div class="left-align">
                                                    <div class="img-bar">
                                    ...
                                    <li>
                                        <a href="{{ route('user.dashboard.emailGenerator') }}" class="genarator-card">
                                            <div class="inner">
                                                <div class="left-align">
                                                    <div class="img-bar">
                                    ...
                                    {{-- <li>
                                        <a href="#" class="genarator-card disabled" tabindex="-1">
                                            <div class="inner">
                                                <div class="left-align">
                                                    <div class="img-bar">
                                                        <img src="assets/images/generator-icon/lyrics.png"
                                                            alt="AI Generator">
                                                    </div>
                ...
                <div class="rbt-static-bar collapse-width">
                    <form class="new-chat-form border-gradient">
                        ...
                        <div class="right-icons">
                            ...
                            <button class="form-icon icon-send" data-bs-toggle="tooltip" data-bs-placement="top"
