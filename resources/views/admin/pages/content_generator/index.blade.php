        ...
        <div class="card-body">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form action="{{ route('admin.content-generator.section.update', $section->id) }}" method="POST"
    ...
    <div class="card">
        <div class="card-body">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h4 class="mb-sm-0 font-size-18">Content Generator List</h4>
                <a href="{{ route('admin.content-generator.create') }}" class="btn btn-primary waves-effect waves-light">Add
                    New</a>
            </div>
                                ...
                                <td>
                                    <div class="dropdown">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li>
                                                <a href="{{ route('admin.content-generator.edit', $row->id) }}"
                                            ...
                                            <li>
                                                <a class="dropdown-item"
                                                    href="{{ route('admin.content-generator.delete', $row->id) }}"
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="view_modal_content">
                                                <label>Icon : </label>
                                                <span class="text-dark"><i class="{{ $row->icon }}"></i></span>
                                            </div>
