        ...
        <div class="card-body">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <form action="{{ route('admin.projects.section.update', $section->id) }}" method="POST"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea class="form-control" name="content" id="content" placeholder="Write description here...." rows="8">{{ old('content', $section->content) }}</textarea>
                                    </div>
                                </div>
                            </div>
    ...
    <div class="card">
        <div class="card-body">
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <a href="{{ route('admin.projects.create') }}" class="btn btn-primary waves-effect waves-light">Add New</a>
            </div>
                    ...
                    <tbody>
                        @foreach ($rows as $key => $row)
                            <tr>
                                ...
                                <td>{{ $row->name }}</td>
                                <td>
                                    <span class="badge bg-info">{{ $row->url_link }}</span>
                                </td>
                                <td>
                                    @if ($row->status == 1)
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li>
                                                <a class="dropdown-item"
                                                    href="{{ route('admin.projects.delete', $row->id) }}"
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg">
                                    <div class="modal-content">
                                        <div class="modal-header bg-primary text-white">
                                            <h1 class="modal-title fs-5" id="exampleModalLabel">View Projects List
                                            </h1>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="view_modal_content">
                                                ...
                                                <span class="text-dark">{{ $row->url_link }}</span>
                                            </div>
