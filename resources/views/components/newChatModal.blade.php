        ...
        <div class="modal-content wrapper top-flashlight light-xl">
            ...
            <div class="genarator-section">
                <ul class="genarator-card-group">
                    ...
                    {{-- <li>
                            <a href="{{ route('user.dashboard.imageGenerator') }}" class="genarator-card">
                                <div class="inner">
                                    <div class="left-align">
                                        <div class="img-bar">
                        ...
                        <li>
                            <a href="{{ route('user.dashboard.imageEditor') }}" class="genarator-card">
                                <div class="inner">
                                    <div class="left-align">
                                        <div class="img-bar">
                    ...
                    {{-- <li>
                        ...
                        <li>
                            <a href="{{ route('user.dashboard.videoGenerator') }}" class="genarator-card">
                                <div class="inner">
                                    <div class="left-align">
                                        <div class="img-bar">
                    ...
                    {{-- <li>
                            <a href="{{ route('user.dashboard.textGenerator') }}" class="genarator-card disabled" tabindex="-1">
                                <div class="inner">
                                    <div class="left-align">
                                        <div class="img-bar">
